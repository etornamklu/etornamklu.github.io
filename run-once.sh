...
# Remove the default theme from _config.yml
sed -i '' '/theme:/d' _config.yml  

# Add custom theme
THEME_NAME="no-style-please"  # Replace with your actual theme
echo "theme: $THEME_NAME" >> _config.yml
echo "Adding the Jekyll theme to Gemfile"
bundle add $THEME_NAME
